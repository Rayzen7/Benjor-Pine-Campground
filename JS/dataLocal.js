const galleryData = {
  "area-panah": [
    "./assets/img/galery/area-panah/img-1.png",
    "./assets/img/galery/area-panah/img-2.png",
    "./assets/img/galery/area-panah/img-3.png",
    "./assets/img/galery/area-panah/img-4.png",
    "./assets/img/galery/area-panah/img-5.png",
    "./assets/img/galery/area-panah/img-6.png"
  ],
  "flying-fox": [
    "./assets/img/galery/flying-fox/img-1.png",
    "./assets/img/galery/flying-fox/img-2.png",
    "./assets/img/galery/flying-fox/img-3.png",
    "./assets/img/galery/flying-fox/img-4.png",
    "./assets/img/galery/flying-fox/img-5.png",
    "./assets/img/galery/flying-fox/img-6.png"
  ],

  "jembatan-tail": [
    "./assets/img/galery/jembatan-tail/img-1.png",
    "./assets/img/galery/jembatan-tail/img-2.png",
    "./assets/img/galery/jembatan-tail/img-3.png",
    "./assets/img/galery/jembatan-tail/img-4.png",
    "./assets/img/galery/jembatan-tail/img-5.png",
    "./assets/img/galery/jembatan-tail/img-6.png"
  ],

  "pondok-kayu": [
    "./assets/img/galery/pondok-kayu/img-1.png",
    "./assets/img/galery/pondok-kayu/img-2.png",
    "./assets/img/galery/pondok-kayu/img-3.png",
    "./assets/img/galery/pondok-kayu/img-4.png",
    "./assets/img/galery/pondok-kayu/img-5.png",
    "./assets/img/galery/pondok-kayu/img-6.png"
  ],

  "panggung": [
    "./assets/img/galery/panggung/img-1.png",
    "./assets/img/galery/panggung/img-2.png",
    "./assets/img/galery/panggung/img-3.png",
    "./assets/img/galery/panggung/img-4.png",
    "./assets/img/galery/panggung/img-5.png",
    "./assets/img/galery/panggung/img-6.png"
  ],

  "mushola": [
    "./assets/img/galery/mushola/img-1.png",
    "./assets/img/galery/mushola/img-2.png",
    "./assets/img/galery/mushola/img-3.png",
    "./assets/img/galery/mushola/img-4.png",
    "./assets/img/galery/mushola/img-5.png",
    "./assets/img/galery/mushola/img-6.png"
  ],

  "kopi": [
    "./assets/img/galery/kopi/img-1.png",
    "./assets/img/galery/kopi/img-2.png",
    "./assets/img/galery/kopi/img-3.png",
    "./assets/img/galery/kopi/img-4.png",
    "./assets/img/galery/kopi/img-5.png",
    "./assets/img/galery/kopi/img-6.png"
  ],
};
...
const testimonialsData = [
  {
    ...
    location: "Pengunjung dari Papua",
    date: "Minggu, 9 Februari, 2024",
    title: "Pengalaman yang Menyegarkan",
    text: "Saya mengunjungi Benjor Pine Campground untuk berlibur akhir pekan, dan itu adalah pelarian sempurna dari kesibukan kota. Kampground ini dikelilingi hutan pinus yang indah dan suasana yang tenang, membuat saya benar-benar bisa bersantai. Aktivitas trekking ke air terjun yang dekat menjadi sorotan utama, dengan pemandangan alam yang luar biasa.",
  ...
  {
    name: "Setio Nugraha",
    location: "Pengunjung dari bandung",
    date: "Minggu, 9 Februari, 2024",
    title: "Liburan Seru dan Menyenangkan",
    text: "Saya menghabiskan akhir pekan di Benjor Pine Campground dan itu adalah pengalaman luar biasa. Suasana alam yang asri, udara segar, dan pemandangan hutan pinus yang menenangkan membuat saya merasa sangat rileks. Aktivitas outbound dan flying fox sangat dan menyenangkan, cocok untuk mengisi waktu bersama teman-teman.",
  ...
  },
  {
    ...
    location: "Pengunjung dari Semarang",
    date: "Minggu, 9 Februari, 2024",
    title: "Liburan yang Tak Terlupakan",
    text: "Berlibur di Benjor Pine Campground benar-benar pengalaman yang luar biasa. Dikelilingi oleh alam yang hijau dan pemandangan yang indah, saya merasa benar-benar terhubung dengan alam. Aktivitas trekking ke coban (air terjun) sangat seru, dan saya bisa menikmati keindahan alam yang masih alami.",
